...
(function(exports) {
  ...
  var wrap = function (mn) {
      return function (mx) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Main line 154, column 1 - line 156, column 29: " + [ mn.constructor.name, mx.constructor.name, v.constructor.name ]);
          };
      };
  };
  ...
  var shuffle = (function () {
      ...
      var go = function (v) {
          var $74 = Data_Array["null"](v.value1);
          if ($74) {
      ...
      return function ($177) {
          return go(Data_Tuple.Tuple.create([  ])($177));
      };
  })();
  var score = function (st) {
      if (st.eating) {
          var $79 = {};
          for (var $80 in st) {
  ...
  var nextApplePos = function (p) {
      var moveNext = function (a$prime) {
          ...
          var $90 = idx >= Data_Array.length(a$prime.pool);
          if ($90) {
              var $91 = {};
              for (var $92 in a$prime) {
                  if ({}.hasOwnProperty.call(a$prime, $92)) {
                      $91[$92] = a$prime[$92];
                  };
              };
              $91.idx = 0;
          ...
          var $94 = {};
          for (var $95 in a$prime) {
              if ({}.hasOwnProperty.call(a$prime, $95)) {
                  $94[$95] = a$prime[$95];
              };
          };
          $94.idx = idx;
      ...
      var checkPlacement = function (p$prime) {
          return function (a$prime) {
              ...
              if (v instanceof Data_Maybe.Just) {
                  var $98 = Data_Eq.eq(eqPosition)(v.value0)(p$prime.pos) || Data_Foldable.elem(Data_Foldable.foldableArray)(eqPosition)(v.value0)(p$prime.trail);
                  if ($98) {
              ...
              throw new Error("Failed pattern match at Main line 250, column 7 - line 255, column 22: " + [ v.constructor.name ]);
          };
      };
      return function ($178) {
          return checkPlacement(p)(moveNext($178));
      };
  };
  ...
  var render = function (ctx) {
      return function (st) {
          ...
          var renderScore = (function () {
              var msg = "Score: " + Data_Show.show(Data_Show.showInt)(st.score);
              return function __do() {
                  Data_Functor["void"](Control_Monad_Eff.functorEff)(Graphics_Canvas.setFont("12px sans-serif")(ctx))();
                  Data_Functor["void"](Control_Monad_Eff.functorEff)(Graphics_Canvas.setFillStyle("white")(ctx))();
                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(Graphics_Canvas.fillText(ctx)(msg)(10.0)(st.boardDim.height - 22.0))();
              };
          })();
          ...
          var renderOverlay = function __do() {
              renderScore();
          ...
          var renderApple = function (a) {
              ...
              throw new Error("Failed pattern match at Main line 363, column 7 - line 365, column 30: " + [ v.constructor.name ]);
          };
          var headColor = (function () {
              var $109 = Data_Eq.eq(eqPlayState)(st.playState)(GameOver.value);
              if ($109) {
  ...
  var playerLogic = function (st) {
      var wrapPlayer = function (p) {
          var $112 = {};
          for (var $113 in p) {
              if ({}.hasOwnProperty.call(p, $113)) {
                  $112[$113] = p[$113];
              };
          };
          $112.pos = wrapPos(0)(tileCount)(0)(tileCount)(p.pos);
          return $112;
      };
      var trimTrail = function (p) {
          if (Data_Array.length(p.trail) > p.len) {
              var $116 = {};
              for (var $117 in p) {
                  if ({}.hasOwnProperty.call(p, $117)) {
                      $116[$117] = p[$117];
                  };
              };
              $116.trail = Data_Maybe.fromMaybe([  ])(Data_Array.tail(p.trail));
              return $116;
          };
          if (Data_Boolean.otherwise) {
              return p;
          };
          throw new Error("Failed pattern match at Main line 186, column 3 - line 221, column 69: " + [ p.constructor.name ]);
      };
          ...
          return function (p) {
              ...
              if (v instanceof LeftArrow) {
                  ...
                  if (Data_Boolean.otherwise) {
                      var $124 = {};
                      for (var $125 in p) {
                          if ({}.hasOwnProperty.call(p, $125)) {
                              $124[$125] = p[$125];
                          };
                      };
                      $124.vel = new Velocity({
                          x: -1 | 0, 
                          y: 0
                      });
                      $124.dir = new Data_Maybe.Just(DirLeft.value);
                      return $124;
                  };
              };
              if (v instanceof UpArrow) {
                  ...
                  if (Data_Boolean.otherwise) {
                      ...
                      $127.vel = new Velocity({
                          x: 0, 
                          y: -1 | 0
                      });
                      $127.dir = new Data_Maybe.Just(DirUp.value);
                      return $127;
                  };
              };
              if (v instanceof RightArrow) {
                  ...
                  if (Data_Boolean.otherwise) {
                      ...
                      $130.vel = new Velocity({
                          x: 1, 
                          y: 0
                      });
                      $130.dir = new Data_Maybe.Just(DirRight.value);
                      return $130;
                  };
              };
              if (v instanceof DownArrow) {
                  ...
                  if (Data_Boolean.otherwise) {
                      ...
                      $133.vel = new Velocity({
                          x: 0, 
                          y: 1
                      });
                      $133.dir = new Data_Maybe.Just(DirDown.value);
                      return $133;
                  };
              };
              throw new Error("Failed pattern match at Main line 186, column 3 - line 221, column 69: " + [ v.constructor.name, p.constructor.name ]);
          };
      };
      var eat = function (e) {
          return function (p) {
      ...
      var addTrail = function (p) {
          var $140 = {};
          for (var $141 in p) {
              if ({}.hasOwnProperty.call(p, $141)) {
                  $140[$141] = p[$141];
              };
          };
          $140.trail = Data_Array.snoc(p.trail)(p.pos);
          return $140;
      };
  ...
  var player = (function () {
      var updatePlayer = function (st) {
          ...
          $143.player = playerLogic(st);
          return $143;
      };
      var checkGameOver = function (st) {
          var $146 = Data_Foldable.elem(Data_Foldable.foldableArray)(eqPosition)(st.player.pos)(st.player.trail);
          if ($146) {
              var $147 = {};
              for (var $148 in st) {
              ...
              $147.playState = GameOver.value;
              return $147;
          };
          return st;
      };
      return function ($179) {
          return checkGameOver(updatePlayer($179));
      };
  })();
  ...
  var eating = function (st) {
      ...
      $152.eating = Data_Maybe.maybe(false)(intersects(st.player.pos))(getApplePos(st.apple));
      return $152;
  };
  var apple = function (st) {
      if (st.eating) {
          ...
          $156.apple = nextApplePos(st.player)(st.apple);
          return $156;
      };
      return st;
  };
  var gameLogic = function (input) {
      return function (st) {
          var step = function ($180) {
              return player(apple(score(eating(updateInput(input)($180)))));
          };
          if (st.playState instanceof NotStarted) {
              var $160 = Data_Eq.notEq(eqActiveInput)(input)(None.value);
              if ($160) {
          ...
          throw new Error("Failed pattern match at Main line 306, column 3 - line 314, column 9: " + [ st.playState.constructor.name ]);
      };
  };
